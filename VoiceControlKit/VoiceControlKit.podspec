Pod::Spec.new do |spec|
  ...
  spec.description  = "iOS framework that enables detecting and handling voice commands using microphone. Built using Swift, and supports online and offline speech recognition."
